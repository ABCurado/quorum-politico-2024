...
{#if !readInstructions}
	<div class="flex flex-col items-center p-6 sm:p-8">
		...
		<p class="text mb-4 text-center sm:text-base">Avalia objetivamente o partido que melhor te representa, longe de <strong>promessas eleitoriais</strong> e <strong>ideologias partidárias</strong>. Sê o teu próprio representante partidário.</p>
